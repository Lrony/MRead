package com.lrony.mread.data.db.table;
...
public class BookTb implements Parcelable {
    ...
    public BookTb(String id, String name, String coverUrl, String describe,
                  ...
                  String latestReadSectionId, int latestReadPage, boolean hasUpdate,
                  Integer sectionCount, int sort, long createTimestamp,
