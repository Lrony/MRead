...
public class BookDetailPackage extends BaseBean {
     ...
     * title : 放开那个女巫
     * author : 二目
     * longIntro : 程岩原以为穿越到了欧洲中世纪，成为了一位光荣的王子。但这世界似乎跟自己想的不太一样？女巫真实存在，而且还真具有魔力？女巫种田文，将种田进行到底。
     ...
     * hiddenPackage : []
     * apptype : [0,1,4]
     * rating : {"count":1985,"score":9.077,"isEffect":true}
     * hasCopyright : true
     * buytype : 2
     * sizetype : -1
     * superscript :
     ...
     * hasCp : true
     * postCount : 15478
     * latelyFollower : 30413
     * followerCount : 0
     * wordCount : 2498723
     * serializeWordCount : 2004
     * retentionRatio : 54.23
     * updated : 2018-04-06T15:05:14.858Z
     * isSerial : true
     * chaptersCount : 1091
     * lastChapter : 第1091章 走投无路的爱情
     * gender : ["male"]
     * tags : []
     * advertRead : true
     * cat : 西方奇幻
    ...
    public List<?> getHiddenPackage() {
        return hiddenPackage;
    }

    public void setHiddenPackage(List<?> hiddenPackage) {
