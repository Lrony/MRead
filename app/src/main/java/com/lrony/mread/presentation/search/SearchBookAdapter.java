 ...
 */
public class SearchBookAdapter extends BaseRecyclerAdapter<SearchBookPackage> {

    public SearchBookAdapter(Context context, SearchBookPackage data) {
        super(context, data);
    }
    ...
    protected void bindData(BaseViewHolder holder, int position) {
        ...
        holder.setText(R.id.tv_type, data.getBooks().get(position).getContentType());
    ...
    public void clear() {
        if (data != null) data.getBooks().clear();
    }
     ...
     * @param data
     */
    public void refresh(SearchBookPackage data) {
        this.data = data;
